      ...
      <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-2xl border border-slate-200 overflow-hidden">
          <div class="flex border-b border-slate-200">
            <button class="login-tab flex-1 py-3 text-sm font-medium text-center transition-colors text-primary-600 bg-primary-50 border-b-2 border-primary-600" data-tab="login">로그인</button>
