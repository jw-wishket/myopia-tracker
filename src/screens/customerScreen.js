    ...
    <div class="space-y-4">
      ...
      <div class="border-t border-slate-200 pt-4">
        ...
        <div class="space-y-2">
          ...
          <input type="date" id="newChildBirth" min="1900-01-01" max="2099-12-31" class="w-full px-3 py-2 border border-slate-200 rounded-lg text-sm focus:outline-none focus:border-primary-400">
